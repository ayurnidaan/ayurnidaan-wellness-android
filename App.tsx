...
export default function App() {
  ...
  if (screen === 'doctor') return <DoctorFlow session={session} onExit={() => setScreen('home')} onOpenShop={() => setScreen('shop')} />;
  if (screen === 'shop') return <ShopFlow session={session} onExit={() => setScreen('home')} onOpenDoctor={() => setScreen('doctor')} />;
...
function ShopFlow({ session, onExit, onOpenDoctor }: { session: Session | null; onExit: () => void; onOpenDoctor: () => void }) {
...
function DoctorFlow({ session, onExit, onOpenShop }: { session: Session | null; onExit: () => void; onOpenShop: () => void }) {
