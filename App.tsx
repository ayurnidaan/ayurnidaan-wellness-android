      ...
      <View style={styles.dashboardBody}>
        {assessmentsComplete && latestPrakriti ? <View style={styles.insightCard}>
          <View style={styles.miniDonutColumn}>
            <View style={styles.homeDoshaPercentages}><Text style={styles.homeDoshaPercentage}>Vata {latestPrakriti.vata}%</Text><Text style={styles.homeDoshaPercentage}>Pitta {latestPrakriti.pitta}%</Text><Text style={styles.homeDoshaPercentage}>Kapha {latestPrakriti.kapha}%</Text></View>
...
const styles = StyleSheet.create({
  ...
  miniDonutColumn: { alignItems: 'center' }, homeDoshaPercentages: { alignItems: 'center', marginBottom: 6, marginRight: 17 }, homeDoshaPercentage: { color: '#68736D', fontSize: 9, fontWeight: '700', lineHeight: 13 },
